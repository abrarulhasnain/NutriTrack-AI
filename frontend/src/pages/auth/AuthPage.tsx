...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="relative w-full max-w-4xl md:h-[550px] bg-white rounded-2xl shadow-xl overflow-hidden">

        {/* MOBILE VIEW: simple stacked card, no split-screen animation */}
        ...
        {/* DESKTOP VIEW: original animated split-screen design */}
